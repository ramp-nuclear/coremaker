...
hafnium = Mixture.alloy(Hf, {Zr: 2.14e-2}, density=12.9, temperature=room_temperature)
# Taken from IRR1
aic = Mixture.by_weight_fraction({Ag: 0.8, In: 0.15, Cd: 0.05}, density=10.17, temperature=room_temperature)
