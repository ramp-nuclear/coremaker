...
class Plane:
    ...
    def isclose(self, other: "Plane") -> bool:
    ...
    def transform(self, transform: Transform) -> "Plane":
        ...
        return Plane(*a_new, float(b_new))
