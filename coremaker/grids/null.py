...
class NullGrid(Grid):
    ...
    def __getitem__(self, key: Site) -> Element: raise KeyError("There are no items im a NullGrid")

    def __setitem__(self, key: Site, value: Element) -> None: pass

    def __delitem__(self, key: Site) -> None: pass

    def __contains__(self, key: Site) -> bool: return False
    ...
    @classmethod
    def deserialize(cls: Type[Self], *_, **__) -> Self: return _null_grid

    def __eq__(self, other: Self) -> bool: return isinstance(other, NullGrid) or NotImplemented

    def __hash__(self): return 37  # Singleton
